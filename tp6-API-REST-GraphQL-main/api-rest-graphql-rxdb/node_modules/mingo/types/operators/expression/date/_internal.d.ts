...
export type DayOfWeek = "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "saturday" | "sunday" | keyof typeof ISO_WEEKDAYS;
...
export declare const MONTHS: Record<string, number>;
 ...
 */
export declare function parseTimezone(timeZone: string | undefined, date: Date): number;
/**
