...
const $exists = (selector, value, _options) => {
  ...
  if (!nested || selector.match(/\.\d+$/)) {
    return (o) => (0, import_internal.resolve)(o, selector) !== void 0 === b;
  }
  return (o) => {
    const path = (0, import_internal.resolveGraph)(o, selector, { preserveIndex: true });
    const val = (0, import_internal.resolve)(path, selector.substring(0, selector.lastIndexOf(".")));
