...
const $shift = (obj, collection, expr, options) => {
  ...
  if (shiftedIndex < 0 || shiftedIndex > collection.length - 1) {
    return input.default ? (0, import_internal.computeValue)(obj, input.default, null, options) : null;
  }
  return (0, import_internal.computeValue)(collection[shiftedIndex], input.output, null, options);
};
