...
const $switch = (obj, expr, options) => {
  ...
  for (const { case: caseExpr, then } of expr.branches) {
    const condition = (0, import_internal2.truthy)(
      (0, import_internal.computeValue)(obj, caseExpr, null, options),
      options.useStrictMode
    );
    if (condition) return (0, import_internal.computeValue)(obj, then, null, options);
  }
  return (0, import_internal.computeValue)(obj, expr.default, null, options);
};
