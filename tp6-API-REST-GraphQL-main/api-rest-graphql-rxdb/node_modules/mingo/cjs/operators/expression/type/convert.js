...
const $convert = (obj, expr, options) => {
  ...
  if ((0, import_util.isNil)(input))
    return (0, import_core.computeValue)(obj, expr.onNull, null, options) ?? null;
  const toExpr = (0, import_core.computeValue)(obj, expr.to, null, options);
  try {
    switch (toExpr) {
      case 2:
      case "string":
  ...
  return (0, import_core.computeValue)(obj, expr.onError, null, options);
};
