...
const $filter = (obj, expr, options) => {
  ...
  const input = (0, import_internal.computeValue)(obj, expr.input, null, options);
  ...
  for (let i = 0, j = 0; i < input.length && j < limit; i++) {
    ...
    const cond = (0, import_internal.computeValue)(obj, expr.cond, null, copts.update(locals));
